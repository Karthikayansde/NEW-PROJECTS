...
public class DateDifference {
    ...
    static int DateDifferenceFinder(boolean start, boolean end, int[] startDate, int[] endDate){
        ...
        if(monthCount == 0 && startDate[1] == endDate[1]){
            ...
            if(startDate[1] == 1 && Mother.isLeap(startDate[2])){
                ...
                totalDays += Mother.MONTHS[startDate[1]] - startDate[0]+1;
                daysCount += Mother.MONTHS[startDate[1]] - startDate[0]+1;
            }
            //
            if(startDate[1] == 1 && Mother.isLeap(startDate[2])){
                totalDays += endDate[0];
