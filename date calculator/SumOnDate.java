public class SumOnDate {
    static int[] dateAdd(int[] current, int[] input){ // input is year, month, week, days
    ...
    static int[] dateSub(int[] current, int[] input){ // input is year, month, week, days
        //changing current values
        current[2] -= input[0];
        // month area
        current[1] -= input[1];
    ...
    // with time------------------------------------------------------------------------------------------------------
    static int[] dateTimeAdd(int[] current, int[] input){ // input is year, month, week, days || hour, minute, second
                                                          //           0      1     2      3       4     5        6
    ...
    //----------------------------------------------------------------------------------------------------------
     ...
     static int[] dateTimeSub(int[] current, int[] input){  // input is year, month, week, days || hour, minute, second
                                                            //           0      1     2      3       4     5        6
